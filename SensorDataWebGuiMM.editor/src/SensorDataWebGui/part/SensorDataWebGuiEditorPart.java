...
import SensorDataWebGui.presentation.SensorDataWebGuiEditorPlugin;

public abstract class SensorDataWebGuiEditorPart extends EditorPart 
implements IMenuListener, IEditingDomainProvider {

	protected SensorDataWebGuiEditor parentEditor;

	public SensorDataWebGuiEditorPart(SensorDataWebGuiEditor parent) {
		super();
