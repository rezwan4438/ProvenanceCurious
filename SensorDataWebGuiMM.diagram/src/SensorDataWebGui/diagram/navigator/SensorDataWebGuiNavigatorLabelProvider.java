 ...
 * @generated
 */
public class SensorDataWebGuiNavigatorLabelProvider extends LabelProvider
	...
	public void updateLabel(ViewerLabel label, TreePath elementPath) {
		...
		if (element instanceof SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem
				&& !isOwnView(((SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) element)
						.getView())) {
			return;
		}
	...
	public Image getImage(View view) {
		...
		case SensorDataWebGui.diagram.edit.parts.StandardSensorDataWebEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Diagram?nl.utwente.ewi.gui?StandardSensorDataWeb", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.StandardSensorDataWeb_1000); //$NON-NLS-1$
		case SensorDataWebGui.diagram.edit.parts.SourceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?nl.utwente.ewi.gui?Source", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.Source_2001); //$NON-NLS-1$
		case SensorDataWebGui.diagram.edit.parts.ProcessingElementEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?nl.utwente.ewi.gui?ProcessingElement", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.ProcessingElement_2002); //$NON-NLS-1$
		case SensorDataWebGui.diagram.edit.parts.FixedWindowEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?nl.utwente.ewi.gui?FixedWindow", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.FixedWindow_4001); //$NON-NLS-1$
		case SensorDataWebGui.diagram.edit.parts.TupleWindowEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?nl.utwente.ewi.gui?TupleWindow", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.TupleWindow_4002); //$NON-NLS-1$
		case SensorDataWebGui.diagram.edit.parts.TimeWindowEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?nl.utwente.ewi.gui?TimeWindow", SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.TimeWindow_4003); //$NON-NLS-1$
		}
	...
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorPlugin
		...
		if (image == null
			...
			image = SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes
	...
	private String getStandardSensorDataWeb_1000Text(View view) {
		SensorDataWebGui.StandardSensorDataWeb domainModelElement = (SensorDataWebGui.StandardSensorDataWeb) view
				.getElement();
	...
	private String getSource_2001Text(View view) {
		IParser parser = SensorDataWebGui.diagram.providers.SensorDataWebGuiParserProvider
				.getParser(
						SensorDataWebGui.diagram.providers.SensorDataWebGuiElementTypes.Source_2001,
