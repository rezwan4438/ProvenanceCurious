 ...
 * @generated
 */
public class SensorDataWebGuiNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorPlugin
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		SensorDataWebGui.diagram.navigator.SensorDataWebGuiAbstractNavigatorItem abstractNavigatorItem = (SensorDataWebGui.diagram.navigator.SensorDataWebGuiAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) {
			navigatorView = ((SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) {
				navigatorView = ((SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
