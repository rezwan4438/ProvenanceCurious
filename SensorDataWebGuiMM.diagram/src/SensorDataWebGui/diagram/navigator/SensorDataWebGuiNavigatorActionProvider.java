 ...
 * @generated
 */
public class SensorDataWebGuiNavigatorActionProvider extends
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					SensorDataWebGui.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) {
					selectedElement = ((SensorDataWebGui.diagram.navigator.SensorDataWebGuiNavigatorItem) selectedElement)
							.getView();
