...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(SensorDataWebGui.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		SensorDataWebGui.diagram.providers.SensorDataWebGuiValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			SensorDataWebGui.diagram.providers.SensorDataWebGuiMarkerNavigationProvider
		...
		validator
				.setTraversalStrategy(SensorDataWebGui.diagram.providers.SensorDataWebGuiValidationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = SensorDataWebGui.diagram.part.SensorDataWebGuiDiagramEditorUtil
