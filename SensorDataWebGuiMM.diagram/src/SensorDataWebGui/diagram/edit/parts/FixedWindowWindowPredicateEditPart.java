 ...
 * @generated
 */
public class FixedWindowWindowPredicateEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SensorDataWebGui.diagram.part.SensorDataWebGuiVisualIDRegistry
						.getType(SensorDataWebGui.diagram.edit.parts.FixedWindowWindowPredicateEditPart.VISUAL_ID),
				new Point(0, 120));
	}
	 ...
	 * @generated
	 */
	public FixedWindowWindowPredicateEditPart(View view) {
		super(view);
	}
