 ...
 * @generated
 */
public class FixedWindowReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FixedWindowReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SensorDataWebGui.FixedWindow) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return SensorDataWebGui.diagram.edit.policies.SensorDataWebGuiBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFixedWindow_4001(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		SensorDataWebGui.StandardSensorDataWeb container = (SensorDataWebGui.StandardSensorDataWeb) getLink()
				.eContainer();
		return SensorDataWebGui.diagram.edit.policies.SensorDataWebGuiBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFixedWindow_4001(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SensorDataWebGui.FixedWindow getLink() {
		return (SensorDataWebGui.FixedWindow) getElementToEdit();
	}
